    ...
    <div class="container">
        <div class="row justify-content-center text-center">
            <div class="col-12 col-lg-8">
                ...
                <div class="d-flex flex-column flex-md-row align-items-center justify-content-center text-muted gap-2">
                    <div>
                    ...
                    <div>{{ __('By') }} {{ $post->author->name }}</div>
                    @if($post->read_time)
                        <span class="d-none d-md-inline">•</span>
                ...
                <div class="mt-5">
                    <img src="{{ $post->getImageUrl() }}" alt="{{ $post->title }}" class="img-fluid rounded-3 shadow-lg w-100" style="max-height: 500px; object-fit: cover;">
                </div>
                @endif
            </div>
        </div>
        ...
        <div class="row g-8">
            <div class="col-12 col-lg-8">
                <article>
                    ...
                    {{-- Share Buttons --}}
                    <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center justify-content-between gap-3 mb-8 pb-8 border-bottom">
