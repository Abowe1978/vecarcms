...
<section class="dwn-full-bleed dwn-features-shortcode py-10 py-lg-15">
    <div class="container">
        ...
        <div class="text-center mb-10">
            <h2 class="display-5 fw-bold mb-3" data-aos="fade-up"><?php echo e($title); ?></h2>
            <?php if(isset($subtitle) && $subtitle): ?>
            <p class="lead text-muted" data-aos="fade-up" data-aos-delay="100"><?php echo e($subtitle); ?></p>
            <?php endif; ?>
        </div>
        <?php endif; ?>
...
<?php /**PATH /Users/carminedamore/Development/gruppobonifacio/content/themes/dwntheme/shortcodes/dwn-features.blade.php ENDPATH**/ ?>