...
<section class="dwn-full-bleed dwn-reviews pb-10">
    <div class="container text-center">
        <p class="mb-3 small fw-bolder tracking-wider text-uppercase text-primary"><?php echo e($subtitle ?? 'Our Feedback'); ?></p>
        <h4 class="fs-1 fw-bold mb-6 mx-auto" style="max-width: 640px;">
            <?php echo e($title ?? 'What our customers are saying about us'); ?>

        </h4>
        <div class="mt-3 d-flex justify-content-center flex-column flex-md-row">
            <a href="<?php echo e($primary_button_url ?? '#'); ?>" class="btn btn-primary mb-2 mb-md-0" role="button">
                <?php echo e($primary_button_text ?? 'Ready to get started?'); ?>

            </a>
            <a href="<?php echo e($secondary_button_url ?? '#'); ?>" class="btn btn-link text-decoration-none text-muted ms-md-2 bg-light-hover" role="button">
                <?php echo e($secondary_button_text ?? 'Start your free trial'); ?>
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div class="text-start">
                                ...
                                <small class="text-muted"><?php echo e($review['role']); ?></small>
                            </div>
                        </div>
                        <p class="text-muted fst-italic">“<?php echo e($review['quote']); ?>”</p>
...
<?php /**PATH /Users/carminedamore/Development/gruppobonifacio/content/themes/dwntheme/shortcodes/dwn-reviews.blade.php ENDPATH**/ ?>