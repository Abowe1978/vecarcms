...
<div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8 py-6">
    <div class="flex justify-between items-center mb-4">
        <h1 class="text-2xl font-bold text-gray-900">{{ __('admin.posts.edit_title') }}</h1>
            ...
            <div class="flex-1 space-y-6">
                <div class="bg-white shadow-sm rounded-lg p-6">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="title" id="title" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" placeholder="{{ __('admin.posts.title_placeholder') }}" value="{{ old('title', $post->title) }}" required>
                        @error('title')
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mt-1 flex items-center">
                            ...
                            <div id="slug-edit-container" class="flex-1 hidden">
                                <input type="text" name="slug" id="slug" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" value="{{ old('slug', $post->slug) }}">
                            </div>
                    ...
                    @include('admin.components.editor-toggle', ['model' => $post])

                    <div class="mb-4">
                        <label for="excerpt" class="block text-sm font-medium text-gray-700">{{ __('admin.posts.excerpt_label') }}</label>
                        <textarea name="excerpt" id="excerpt" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" rows="3" placeholder="{{ __('admin.posts.excerpt_placeholder') }}">{{ old('excerpt', $post->excerpt) }}</textarea>
                        @error('excerpt')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="border-t border-gray-200 pt-4 mt-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="meta_title" name="meta_title" value="{{ old('meta_title', $post->meta_title) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" placeholder="{{ __('admin.seo.meta_title_placeholder') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="meta_description" name="meta_description" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" placeholder="{{ __('admin.seo.meta_description_placeholder') }}">{{ old('meta_description', $post->meta_description) }}</textarea>
                        ...
                        <div class="mb-4" style="display: none;">
                            ...
                            <input type="text" id="meta_keywords" name="meta_keywords" value="{{ old('meta_keywords', $post->meta_keywords) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" placeholder="{{ __('admin.seo.meta_keywords_placeholder') }}">
                ...
                <div class="bg-white shadow-sm rounded-lg p-6">
                    <div class="mb-4">
                        ...
                        <select name="status" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            <option value="draft" {{ old('status', $post->status) == 'draft' ? 'selected' : '' }}>{{ __('admin.posts.status_draft') }}</option>
                            <option value="published" {{ old('status', $post->status) == 'published' ? 'selected' : '' }}>{{ __('admin.posts.status_published') }}</option>
                        </select>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div x-data="mediaSelector('featured_image', '{{ $post->featured_image }}')" class="space-y-2">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mt-2 p-4 bg-gray-50 rounded-lg border border-gray-200">
                            @livewire('category-selector', ['categories' => old('categories', $post->categories->pluck('id')->toArray())])
                        </div>
                    </div>
